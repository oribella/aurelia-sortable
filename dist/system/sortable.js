System.register(["aurelia-pal", "aurelia-templating", "aurelia-dependency-injection", "oribella-default-gestures"], function (_export) {
  "use strict";

  var DOM, customAttribute, bindable, inject, transient, oribella, matchesSelector, Sortable, SortableItem;
  ...
  return {
    ...
    execute: function () {
      Sortable = (function () {
        ...
        Sortable = inject(DOM.Element)(Sortable) || Sortable;
